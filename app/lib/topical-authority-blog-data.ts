...
export const topicalBlogArticles: TopicalArticle[] = [
  ...
  },
  {
    ...
    internalLinks: [...makeCommonLinks(), { label: "Konveyör ve Helezon", href: "/kutuphane/blog/konveyor-ve-helezon" }, { label: "Taşıma Ekipmanları", href: "/makinalar/tasima-ekipmanlari" }],
    relatedContents: [
    ...
    relatedServices: [
      { title: "Taşıma Ekipmanları", description: "Konveyör, helezon ve elevatör ailesini inceleyin.", href: "/makinalar/tasima-ekipmanlari" },
  ...
  },
  {
    ...
    relatedServices: [
      { title: "Taşıma Ekipmanları", description: "Konveyör ailesini kategori bazında inceleyin.", href: "/makinalar/tasima-ekipmanlari" },
  ...
  },
  {
    ...
    relatedServices: [
      { title: "Taşıma Ekipmanları", description: "Eğimli helezonların yer aldığı ekipman ailesi.", href: "/makinalar/tasima-ekipmanlari" },
