...
function buildProductSpecificDryingPage({
  ...
  return page({
    ...
    ctaTertiaryHref: "/programlar?modal=tambur-kapasite-hesabi",
...
export const dryingSystemDetailPages: DrumSystemDetailPageData[] = [
  page({
    ...
    relatedLinks: [
      { title: "Tambur Hesapları", description: "Kapasite, devir, eğim ve yardımcı ekipman hesaplarını açın.", href: "/programlar?modal=tambur-kapasite-hesabi" },
      ...
      { title: "Ã‡amur Kurutma Tesisi", description: "Yüksek nemli akışlarda kurutma yükünü hizmet perspektifinden inceleyin.", href: "/sektorler/atik-su-camuru-ve-aritma-cozumleri" },
  ...
  page({
    ...
    relatedLinks: [
      ...
      { title: "Tambur Hesapları", description: "Program üzerinden kapasite, devir ve eğim araçlarını açın.", href: "/programlar?modal=tambur-kapasite-hesabi" },
  ...
  page({
    ...
    relatedLinks: [
      { title: "Ã‡amur Kurutma Tesisi", description: "Hizmet sayfasında saha ve çözüm yaklaşımını inceleyin.", href: "/sektorler/atik-su-camuru-ve-aritma-cozumleri" },
