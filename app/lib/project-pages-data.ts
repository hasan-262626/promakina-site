...
export const projectPages: ProjectPageData[] = [
  {
    ...
    investorBenefits: [
      ...
      "Geri kazanım değerini yükselten daha kontrollü bir proses omurgası oluşur",
    ],
    quoteRequirements: [
  ...
  },
  {
    ...
    investorBenefits: [
      ...
      "Satılabilir veya kullanılabilir son ürüne geçiş kolaylaşır",
    ],
    quoteRequirements: [
  ...
  },
  {
    ...
    quoteRequirements: [
      ...
      "Parçalama ihtiyacı ve nem seviyesi",
  ...
  },
  {
    ...
    projectScope: [
      ...
      "Digestat sonrası değerlendirme ve saha lojistiğinin projelendirilmesi",
    ],
    machineGroups: [
  ...
  },
  {
    ...
    investorBenefits: [
      "Digestat için bertaraf yerine geri kazanım senaryosu oluşur",
  ...
  },
  {
    ...
    heroDescription:
      "10 ton/saat ölçeğinde organomineral gübre yatırımlarında formülasyon, kapasite, granül kalitesi ve saha yerleşimini birlikte ele alan proses kurguları geliştiriyoruz.",
    ...
    quoteRequirements: [
      ...
      "Organik ve mineral ham madde dağılımı",
  ...
  },
  {
    ...
    investorBenefits: [
      ...
      "Kapasite ve kalite dengesini kuran yatırım omurgası oluşur",
      "İleride kapasite artışına uygun esnek kurgu sağlanır",
    ],
    quoteRequirements: [
  ...
  },
  {
    ...
    machineGroups: [
      ...
      "Sıvı dolum, şişeleme ve etiketleme sistemleri",
    ],
    processFlow: [
    ...
    investorBenefits: [
      ...
      "Farklı ürün reçetelerine uyum sağlayan esnek yapı oluşur",
    ],
    quoteRequirements: [
  ...
  },
  {
    ...
    quoteRequirements: [
      ...
      "Toz kontrolü ve stoklama ihtiyacı",
    ],
    relatedLinks: [
  ...
  },
  {
    ...
    heroDescription:
      "Arıtma çamuru kurutma projelerinde nem düşürme hedefi, koku kontrolü, ürün hazırlama ve saha akışı aynı termal proses mantığı içinde okunur.",
    ...
    projectScope: [
      "Nem düşürme hedefi ve günlük tonaja göre kurutma yapısının belirlenmesi",
    ...
    investorBenefits: [
      ...
      "Koku ve toz riski başlangıçta ele alınır",
  ...
  },
  {
    ...
    investorBenefits: [
      ...
      "Geri kazanım verimi için düzenli ön hazırlık yapısı oluşur",
      "Standart dışı atık senaryolarında özel çözüm omurgası sağlanır",
    ],
    quoteRequirements: [
  ...
  },
  {
    ...
    heroDescription:
      "Malzeme transferinin yalnızca makine seçimi değil, hat boyu, eğim, dozaj ve bakım erişimiyle birlikte planlandığı taşıma sistemi projeleri geliştiriyoruz.",
    ...
    projectScope: [
      "Malzeme tipi, mesafe, eğim ve kapasiteye göre taşıma hattının kurgulanması",
  ...
  },
  {
    ...
    quoteRequirements: [
      ...
      "Karıştırma ve sıcaklık kontrol ihtiyacı",
  ...
  },
  {
    ...
    heroDescription:
      "Saha ölçülerine, kapasiteye ve proses hedefine göre katalog dışı ekipman ve hat çözümleri tasarlayarak özel üretim gerektiren yatırımları destekliyoruz.",
    image: "/images/makinalar1.png",
    ...
    projectScope: [
      "Standart dışı ihtiyaçların saha verileriyle birlikte okunması",
