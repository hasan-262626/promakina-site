...
const dryingData: BlogTechnicalArticleData = {
  ...
  factorCards: [
    ...
    { title: "Giriş nemi", description: "Residence time ve enerji yükünü doğrudan artırır." },
    ...
    { title: "Saha yerleşimi", description: "Tambur uzunluğu ve bakım erişimi fiziksel alana uymalıdır." },
  ],
  ...
  relatedLinks: [
    ...
    { title: "Kurutma Tamburları", description: "Ürün detay sayfası üzerinden kapasite ve ekipman yaklaşımını değerlendirin.", href: "/makinalar-ekipman/tambur-sistemleri/kurutma-tamburlari" },
    ...
    { title: "Çamur Kurutma Tesisi", description: "Yüksek nemli akışlarda kurutma ve koku kontrolü yaklaşımını inceleyin.", href: "/hizmetler/camur-kurutma-tesisi" },
  ],
};
...
const screwData: BlogTechnicalArticleData = {
  ...
  relatedLinks: [
    { title: "Helezon Konveyörler", description: "Helezon ürün ailesini makina kategorisinde inceleyin.", href: "/makinalar-ekipman/tasima-ekipmanlari/helezon-konveyorler" },
    ...
    { title: "Bant Konveyörler", description: "Alternatif taşıma omurgalarını makina kategorisinde inceleyin.", href: "/makinalar-ekipman/tasima-ekipmanlari/bant-konveyorler" },
    { title: "Kovalı Elevatörler", description: "Dikey taşıma hatları için ilgili ekipman ailesine bakın.", href: "/makinalar-ekipman/tasima-ekipmanlari/kovali-elevatorler" },
  ],
};
...
const conveyorData: BlogTechnicalArticleData = {
  ...
  decisionTableRows: [
    { criterion: "Bant genişliği", description: "Kesit alanını belirler.", importance: "Kapasite için temel girdidir.", effect: "Yetersiz seçilirse taşma riski oluşur." },
  ...
  relatedLinks: [
    { title: "Bant Konveyörler", description: "Bantlı taşıma ürün ailesini makina kategorisinde görün.", href: "/makinalar-ekipman/tasima-ekipmanlari/bant-konveyorler" },
    ...
    { title: "Kovalı Elevatörler", description: "Dikey taşıma çözümlerini ilgili makina grubunda inceleyin.", href: "/makinalar-ekipman/tasima-ekipmanlari/kovali-elevatorler" },
...
const fertilizerData: BlogTechnicalArticleData = {
  ...
  requiredDataRows: [
    ...
    { label: "Kurutma ihtiyacı", purpose: "Tambur ve enerji modelini tanımlar.", request: "Var / yok" },
  ...
  exampleRows: [
    ...
    { label: "Granülasyon", value: "Şekillendirme", comment: "Granül kalitesinin ana aşamasıdır" },
  ...
  decisionTableRows: [
    ...
    { criterion: "Paketleme", description: "Son ürünün satışa hazır hale gelmesini sağlar.", importance: "Tesis ritmini son aşamada belirler.", effect: "Zayıf hat tüm üretimi yavaşlatır." },
  ],
  ...
  factorCards: [
    ...
    { title: "Kurutma ihtiyacı", description: "Enerji modeli ve tambur seçimini doğrudan etkiler." },
...
const compostData: BlogTechnicalArticleData = {
  ...
  factorCards: [
    ...
    { title: "Nem seviyesi", description: "Biyolojik aktivite ve kurutma ihtiyacı üzerinde belirleyicidir." },
    ...
    { title: "Olgunlaşma süresi", description: "Alan ihtiyacı ve stok planını büyütür." },
...
const biogasData: BlogTechnicalArticleData = {
  ...
  requiredDataRows: [
    ...
    { label: "Koku ve hijyen", purpose: "Saha yerleşimi ve çevresel kontrolü etkiler.", request: "Fan / filtre ihtiyacı" },
  ],
  exampleTitle: "Örnek Süreç Akışı",
  exampleDescription:
...
const liquidData: BlogTechnicalArticleData = {
  ...
  requiredDataRows: [
    ...
    { label: "Filtrasyon ihtiyacı", purpose: "Dolum öncesi ürün temizliğini etkiler.", request: "Torba / kartuş / inline" },
  ...
  factorCards: [
    ...
    { title: "Filtrasyon ihtiyacı", description: "Dolum kalitesi ve hat temizliğini etkiler." },
...
const defaultTechnicalData: BlogTechnicalArticleData = {
  ...
  decisionTableRows: [
    ...
    { criterion: "Yerleşim", description: "Sahanın fiziksel koşullarıdır.", importance: "Montaj ve servis için kritiktir.", effect: "Sıkışık yerleşim bakım zorluğu yaratır." },
  ],
