...
export const liquidFertilizerDetailPages: DrumSystemDetailPageData[] = [
  page({
    ...
    relatedLinks: [
      ...
      { title: "Sıvı Gübre Üretim Tesisi", description: "Hizmet sayfasında tesis çözüm yaklaşımını görün.", href: "/hizmetler/sivi-gubre-uretim-tesisi" },
  ...
  page({
    ...
    relatedLinks: [
      ...
      { title: "Reaktörler ve Tanklar", description: "İlgili makine grubunu ürün sayfalarıyla inceleyin.", href: "/makinalar-ekipman/reaktorler-ve-tanklar" },
      { title: "Sıvı Gübre Üretim Tesisi", description: "Hizmet sayfasında proje yaklaşımını görün.", href: "/hizmetler/sivi-gubre-uretim-tesisi" },
  ...
  page({
    ...
    relatedLinks: [
      ...
      { title: "Sıvı Gübre Üretim Tesisi", description: "Tank zincirinin tesis çözümündeki yerini görün.", href: "/hizmetler/sivi-gubre-uretim-tesisi" },
  ...
  page({
    ...
    relatedLinks: [
      ...
      { title: "Sıvı Gübre Üretim Tesisi", description: "Tesiste çözündürme adımının yerini hizmet kurgusuyla görün.", href: "/hizmetler/sivi-gubre-uretim-tesisi" },
  ...
  page({
    ...
    relatedLinks: [
      ...
      { title: "Sıvı Gübre Üretim Tesisi", description: "Filtrasyonun tesis çözümündeki yerini görün.", href: "/hizmetler/sivi-gubre-uretim-tesisi" },
  ...
  page({
    ...
    relatedLinks: [
      ...
      { title: "Sıvı Gübre Üretim Tesisi", description: "Dolum hattının tesis çözümündeki yerini görün.", href: "/hizmetler/sivi-gubre-uretim-tesisi" },
  ...
  page({
    ...
    relatedLinks: [
      ...
      { title: "Sıvı Gübre Üretim Tesisi", description: "Amino asitli ürünlerin tesis kurgusunu hizmet sayfasında görün.", href: "/hizmetler/sivi-gubre-uretim-tesisi" },
  ...
  page({
    ...
    relatedLinks: [
      ...
      { title: "Sıvı Gübre Üretim Tesisi", description: "Biyostimülan üretiminin tesis bazlı çözümünü görün.", href: "/hizmetler/sivi-gubre-uretim-tesisi" },
  ...
  page({
    ...
    relatedLinks: [
      ...
      { title: "Sıvı Gübre Üretim Tesisi", description: "Bu ürün grubunun tesis çözümünü görün.", href: "/hizmetler/sivi-gubre-uretim-tesisi" },
