...
export const sectorExperienceConfigs: Record<string, SectorExperienceConfig> = {
  "kompost-ve-organik-atik-tesisleri": {
    ...
    offerCards: [
      ...
      { title: "Hat yerleşimi", text: "Besleme, tambur, eleme ve stok noktalarını saha lojistişiyle uyumlu şekilde planlıyoruz." },
    ...
    equipmentTitle: "Kompost ve organik atık işleme için kullanılan bağlıca makine ve ekipmanlar",
    ...
    equipmentCards: [
      ...
      { title: "Kurutma tamburları", text: "Yüksek nemli organik akışlarda hacim azaltma ve nem düğürme için kullanılır." },
    ...
    faqDescription: "Kompost yatırımlarında en sık karşılaşılan teknik ve operasyonel bağlıkları tek yerde topladık.",
    faqs: [
      ...
      { question: "Kurutma her kompost tesisinde gerekli midir?", answer: "Hayır, kurutma ihtiyaçı atığın nemine, depolama planına ve hedef son ürün yapısına göre belirlenir." },
  ...
  "enerji-ve-biyogaz-sistemleri": {
    ...
    primaryCards: [
      { title: "Girdi tipi", text: "Tarımsal, hayvansal veya gıda kaynaklı akışlar için hazırlama ve besleme mantığı farklılağır." },
    ...
    offerCards: [
      ...
      { title: "Revizyon ve entegrasyon", text: "Mevcut biyogaz veya enerji hatlarına yeni ekipman ve proses desteşi entegre ediyoruz." },
      { title: "Kurulum ve devreye alma", text: "İmalat, montaj ve devreye alma sürecini tek merkezden yönetiyoruz." },
    ],
    equipmentEyebrow: "Makine ve Ekipman",
    equipmentTitle: "Enerji ve biyogaz sistemlerinde kullanılan bağlıca makine ve ekipmanlar",
    equipmentDescription:
    ...
    faqDescription: "Biyogaz ve enerji projelerinde girdi, kapasite ve saha kurgusuna dair sık sorulan bağlıkları derledik.",
    faqs: [
  ...
  "madencilik-ve-mineral-isleme": {
    ...
    offerCards: [
      ...
      { title: "Hat yerleşimi", text: "Bunker, transfer ve stok noktalarını saha lojistişine uygun şekilde planlıyoruz." },
    ...
    equipmentEyebrow: "Makine ve Ekipman",
    equipmentTitle: "Madencilik ve mineral işleme için kullanılan bağlıca makine ve ekipmanlar",
    equipmentDescription:
    ...
    equipmentCards: [
      ...
      { title: "Kurutma tamburları", text: "Nemli mineral akışları için kontrollü kurutma desteşi sağlar." },
    ...
    faqs: [
      { question: "Primer ve sekonder kırma seçimi nasıl yapılır?", answer: "Giriş boyutu, hedef ürün, malzeme sertliği ve kapasite ihtiyaçı birlikte değerlendirilerek seçim yapılır." },
      ...
      { question: "Mevcut kırma-eleme hattı revize edilebilir mi?", answer: "Evet, mevcut ekipman parkı incelenerek kapasite artığı ve proses iyileştirmesi yapılabilir." },
      { question: "Kurutma ve soğutma ne zaman gerekli olur?", answer: "Malzemenin nemi, hedef kondisyonu ve depolama gereksinimine göre kurutma-soğutma ihtiyaçı netleşir." },
    ],
  },
  "kimya-ve-proses-endustrisi": {
    ...
    primaryDescription:
      "Kimya ve proses hatlarında ekipman seçimi; ürünün viskozitesi, kimyasal uyumluluğu, sıcaklık ihtiyaçı ve çalışma ?xekline göre şekillenir.",
    primaryCards: [
      ...
      { title: "Sıcaklık yönetimi", text: "Isıtma veya soğutma ihtiyaçı, proses verimliliği ve ekipman yapısını belirler." },
    ],
    offerEyebrow: "Sunulan Çözümler",
    offerTitle: "Kimya ve proses endüstrisi için sunduğumuz çözümler",
    offerDescription:
      "Karıştırma, çözündürme, reaksiyon ve transfer süreçlerini bir arada düğünerek güvenli ve sürdürülebilir tesis altyapıları kuruyoruz.",
    offerCards: [
    ...
    equipmentEyebrow: "Makine ve Ekipman",
    equipmentTitle: "Kimya ve proses endüstrisinde kullanılan bağlıca makine ve ekipmanlar",
    equipmentDescription:
    ...
    faqDescription: "Kimya tesislerinde ekipman seçimi, çalışma ?xekli ve güvenlik gereksinimlerine dair sık sorulan bağlıkları derledik.",
    faqs: [
      ...
      { question: "Basınçlı sistem her uygulamada gerekli midir?", answer: "Hayır, basınçlı sistem ihtiyaçı ürün yapısı ve proses koşullarına göre belirlenir." },
      { question: "Paslanmaz ekipman ne zaman tercih edilmelidir?", answer: "Korozyon riski, hijyen ihtiyaçı ve ürün saflığı beklentisi olan uygulamalarda tercih edilir." },
  ...
  "geri-donusum-ve-atik-yonetimi": {
    ...
    offerCards: [
      ...
      { title: "Çevresel kontrol", text: "Toz, emisyon ve saha güvenliği bağlıklarını süreçle birlikte planlıyoruz." },
      { title: "Kurulum ve devreye alma", text: "İmalat, saha kurulumu ve işletmeye alma süreçlerini kontrollü biçimde yürütüyoruz." },
    ],
    equipmentEyebrow: "Makine ve Ekipman",
    equipmentTitle: "Geri dönüşüm ve atık yönetiminde kullanılan bağlıca makine ve ekipmanlar",
    equipmentDescription:
      "Atık işleme hatlarında ekipmanlar, güvenlik ve esneklik ihtiyaçı dikkate alınarak bir bütün halinde değerlendirilmelidir.",
    equipmentCards: [
      ...
      { title: "Toz kontrol sistemleri", text: "Tozlu proses noktalarında emiş ve filtrasyon desteşi verir." },
    ...
    faqs: [
      ...
      { question: "Mobil ve sabit tesis seçimi nasıl yapılır?", answer: "Saha yapısı, atık kaynaşı, kapasite ve lojistik gereksinimleri birlikte değerlendirilerek karar verilir." },
  ...
  "atik-su-camuru-ve-aritma-cozumleri": {
    ...
    primaryCards: [
      { title: "Giriş nemi", text: "Kurutma sistemi, enerji ihtiyaçı ve hat ölçeşi giriş nemine göre şekillenir." },
    ...
    offerEyebrow: "Sunulan Çözümler",
    offerTitle: "Atık su çamuru çözümleri için sunduğumuz çözümler",
    offerDescription:
      "Susuzlaştırma, kurutma, transfer ve son ürün yönetimi bağlıklarını bir bütün halinde ele alarak sahaya uygun çözümler sunuyoruz.",
    offerCards: [
    ...
    equipmentEyebrow: "Makine ve Ekipman",
    equipmentTitle: "Atık su çamuru çözümlerinde kullanılan bağlıca makine ve ekipmanlar",
    equipmentDescription:
    ...
    faqDescription: "Arıtma projelerinde nem, enerji ve son ürün yönetimiyle ilgili en sık sorulan bağlıkları özetledik.",
    faqs: [
  ...
  "yem-toz-ve-dokme-kati-malzeme-isleme-sistemleri": {
    ...
    primaryDescription:
      "Dökme katı malzeme işleme hatlarında akış davranışı, toz oluğumu, dozaj hassasiyeti ve son ürün lojistişi birlikte değerlendirilmelidir.",
    primaryCards: [
      { title: "Akış davranışı", text: "Malzemenin köprülenme eşilimi ve akışkanlığı bunker ile besleme tasarımını belirler." },
    ...
    equipmentEyebrow: "Makine ve Ekipman",
    equipmentTitle: "Yem, toz ve dökme katı malzeme işleme için kullanılan bağlıca makine ve ekipmanlar",
    equipmentDescription:
    ...
    faqDescription: "Depolama, dozajlama ve son ürün lojistişiyle ilgili sık sorulan bağlıkları bir araya getirdik.",
    faqs: [
