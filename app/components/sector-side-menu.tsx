...
import type { SectorSubsectorItem } from "./sector-subsectors-data";

type SectorSideMenuProps = {
  parentTitle: string;
  parentHref: string;
  items: SectorSubsectorItem[];
  currentSlug: string;
};

export function SectorSideMenu({
  parentTitle,
  parentHref,
  items,
  currentSlug,
            ...
            >
              ...
              <span
                className={`text-base transition-transform duration-200 ${
                  isActive ? "text-white" : "text-white/70 group-hover:translate-x-1 group-hover:text-white"
                }`}
              >
                →
              </span>
