  ...
  return (
    <section className="bg-[linear-gradient(180deg,#f8fafc_0%,#ffffff_42%,#f8fafc_100%)] pb-14 pt-8 lg:pb-16 lg:pt-10">
      <div className="site-container">
        ...
        <div className="mt-6 grid gap-6 xl:grid-cols-[1.03fr_0.97fr]">
          <div className="space-y-6">
            <div className="rounded-3xl border border-blue-100 bg-white p-6 shadow-[0_18px_50px_rgba(15,23,42,0.06)]">
              ...
              <p className="mt-3 text-sm leading-7 text-slate-600">Gerekli tüm girişleri tek panelden doldurun. Program anlık olarak uygun bantlı konveyör seçimi ve mekanik tavsiyeleri üretir.</p>
              ...
              <div className="mt-6 grid gap-5 md:grid-cols-2">
                ...
                <ToolkitInput label="Saatlik kapasite" value={capacity} onChange={setCapacity} unit="ton/saat" helperText="Bu alanı siz doldurun" limitText="Saatlik debi sıfırdan büyük olmalıdır" tip="Müşterinin talep ettiği net kapasite değeri." tipId="conv-capacity" openTip={openTip} setOpenTip={setOpenTip} />
                ...
                <ToolkitInput label="Konveyör boyu" value={length} onChange={setLength} unit="m" helperText="Bu alanı siz doldurun" limitText="Boy ve döküş yüksekliğinden eğim açı hesabı yapılabilir" tip="Konveyörün toplam taşıma boyudur." tipId="conv-length" openTip={openTip} setOpenTip={setOpenTip} />
                <ToolkitInput label="Döküş yüksekliği" value={dischargeHeight} onChange={setDischargeHeight} unit="m" helperText="Bu alanı siz doldurun" limitText="Boy ile birlikte girilirse eğim açısı otomatik hesaplanır" tip="Konveyörün ürünü bırakacağı yükseklik farkıdır." tipId="conv-height" openTip={openTip} setOpenTip={setOpenTip} />
                ...
                {angleMode === "manual" ? <ToolkitInput label="Eğim açısı" value={manualAngle} onChange={setManualAngle} unit="°" helperText="Bu alanı siz doldurun" limitText="0° ile 25° arası önerilir" tip="Konveyörün yatay hatta göre eğim açısıdır." tipId="conv-angle" openTip={openTip} setOpenTip={setOpenTip} /> : null}
              ...
              <div className="mt-6 rounded-3xl border border-slate-200 bg-slate-50 p-5">
                ...
                <div className="mt-4 grid gap-5 md:grid-cols-2">
                  {mode === "width_to_speed" ? <>
                    ...
                    <ToolkitInput label="Tambur çapı varsayımı" value={driveDrumDiameter} onChange={setDriveDrumDiameter} unit="mm" helperText="Bu alanı siz doldurun" limitText="Redüktör çıkış devri hesabında kullanılır" tip="Tahrik tamburu çapı bant hızı ve rpm ilişkisinde kullanılır." tipId="conv-drum" openTip={openTip} setOpenTip={setOpenTip} />
                  </> : <>
                    ...
                    <ToolkitInput label="Tambur çapı varsayımı" value={driveDrumDiameter} onChange={setDriveDrumDiameter} unit="mm" helperText="Bu alanı siz doldurun" limitText="Hız ile rpm dönüşümünde kullanılır" tip="Tahrik tamburu çapı bant hızı ve rpm ilişkisinde kullanılır." tipId="conv-drum-2" openTip={openTip} setOpenTip={setOpenTip} />
                    {speedMode === "speed" ? <ToolkitInput label="Bant hızı" value={selectedSpeed} onChange={setSelectedSpeed} unit="m/sn" helperText="Bu alanı siz doldurun" limitText="Seçilen hıza göre gerekli bant genişliği hesaplanır" tip="Konveyör bandının hedef çevresel hızıdır." tipId="conv-speed" openTip={openTip} setOpenTip={setOpenTip} /> : <ToolkitInput label="Redüktör çıkış devri" value={selectedRpm} onChange={setSelectedRpm} unit="rpm" helperText="Bu alanı siz doldurun" limitText="Tambur çapına göre bant hızına çevrilir" tip="Redüktör çıkışında beklenen tambur devridir." tipId="conv-rpm" openTip={openTip} setOpenTip={setOpenTip} />}
                  </>}
                </div>
              </div>
          ...
          <div className="space-y-6 xl:sticky xl:top-6 xl:self-start">
            ...
            <ToolkitLead title="PDF, yazdırma ve teklif özeti hazır" text={`Müşteri: ${customerName || "Belirtilmedi"} | Proje: ${projectName || "Belirtilmedi"} | Tarih: ${dateValue || "Belirtilmedi"}. Bu ön seçim çıktısını PDF olarak kaydedebilir veya yazdırabilirsiniz.`} />
          </div>
        </div>
      </div>
    </section>
