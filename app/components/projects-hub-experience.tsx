...
const featuredProjectCards: ContentCard[] = [
  {
    title: "10 Ton/Saat Organomineral Gübre Tesisi",
    description:
      "Dozajlama, granülasyon, kurutma, eleme ve paketleme adımlarını entegre kurgulayan gübre tesisi projesi.",
    href: "/projeler/10-ton-saat-organomineral-gubre-tesisi",
    image: "/images/01-genel/gran2.jpg",
    imageAlt: "10 ton saat organomineral gübre tesisi projesi",
  },
  {
    title: "Granül Gübre Üretim Tesisi",
    description:
      "NPK ve organomineral ürünlerde granülasyon, termal proses ve son ürün hazırlama odaklı proje referansı.",
    href: "/projeler/granul-gubre-uretim-tesisi",
  ...
  },
  {
    ...
    description:
      "Organik atık kabulünden eleme ve son ürün hazırlamaya kadar kompost prosesini bütüncül ele alan tesis kurgusu.",
    href: "/projeler/evsel-atiklardan-kompost-tesisi",
  ...
  },
  {
    ...
    description:
      "Digestatın kurutma, kompostlaştırma ve değerli son ürüne dönüşümünü hedefleyen entegre saha çözümü.",
    href: "/projeler/biyogaz-digestat-kurutma-kompost-projesi",
    image: "/images/biyogaz/biogaz1.jpg",
  ...
  },
  {
    ...
    description:
      "Nem düşürme, gaz yönetimi, toz kontrolü ve nihai ürün hazırlama adımlarını kapsayan arıtma projesi.",
    href: "/projeler/aritma-camuru-kurutma-tesisi",
    image: "/images/01-genel/proje2.jpg",
  ...
  },
  {
    ...
    description:
      "Mineral ürünlerde kurutma, eleme, taşıma ve stoklamayı kapasiteye uygun kuran maden tesisi projesi.",
    href: "/projeler/silis-kumu-kurutma-tesisi",
    image: "/images/maden/maden2.webp",
    imageAlt: "Silis kumu kurutma tesisi projesi",
  },
  {
    title: "Reaktör ve Tank Sistemleri",
    description:
      "Sıvı proseslerde çözündürme, karıştırma, stoklama ve dolum bağlantılarını bir araya getiren proje yapısı.",
    href: "/projeler/reaktor-ve-tank-sistemleri-projesi",
    image: "/images/01-genel/proses1.png",
  ...
  },
  {
    ...
    description:
      "Dökme katı ürünlerin besleme, transfer ve ara stoklama adımlarını netleştiren taşıma sistemi projesi.",
    href: "/projeler/helezon-konveyor-elevator-hat-projesi",
...
function VisualCard({ title, description, href, image, imageAlt }: ContentCard) {
  return (
    <Link
      href={href}
      className="group overflow-hidden rounded-[28px] border border-[#d9e6ee] bg-white shadow-sm transition duration-200 hover:-translate-y-1 hover:border-[#278DC0]/40 hover:shadow-[0_20px_50px_rgba(15,23,42,0.08)]"
    >
      {image ? (
      ...
      <section className="section-bottom-space">
        <div className="site-container">
          <SectionHeading
            ...
            description="Gerçek saha uygulamalarından seçilmiş proje başlıkları üzerinden Pro Makina’nın farklı proseslerde nasıl çalıştığını inceleyebilirsiniz."
          />
          <div className="mt-8 grid gap-6 lg:grid-cols-2 xl:grid-cols-4">
