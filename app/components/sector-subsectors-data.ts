...
export const sectorCards: SectorCardItem[] = [
  {
    ...
    subLinks: [
      ...
      { slug: "granul-kompost-tesisleri", label: "Granül Kompost Tesisleri", title: "Granül Kompost Tesisleri", description: "Kompost bazlı hammaddeleri granül son ürüne dönüştüren tesisler." },
  ...
  },
  {
    ...
    subLinks: [
      ...
      { slug: "acik-sistem-camur-kurutma", label: "Açık Sistem Çamur Kurutma", title: "Açık Sistem Çamur Kurutma", description: "Uygun saha şartlarında daha yalın akış kurgusuyla planlanan açık sistem çamur kurutma çözümleri." },
      { slug: "atik-su-camurundan-aty-hazirlama", label: "Atık Su Çamurundan ATY Hazırlama", title: "Atık Su Çamurundan ATY Hazırlama", description: "Kurutulmuş çamurun atıktan türetilmiş yakıt senaryolarına hazırlanması için proses ve ürün hazırlama çözümleri." },
      { slug: "atik-su-camurundan-kompost-uretimi", label: "Atık Su Çamurundan Kompost Üretimi", title: "Atık Su Çamurundan Kompost Üretimi", description: "Uygun karışım ve proses şartlarında çamurun organik fraksiyonlarla birlikte kompost değerlendirme senaryoları." },
    ],
  },
  {
