...
export const services: ServiceItem[] = [
  ...
  },
  {
    ...
    relatedProjects: ["özel Proses ve Makine 0malatı"],
    faqs: [
      {
  ...
  },
  {
    ...
    scope: ["özel ölçü imalat", "Malzeme seçimi", "Atolye ?retimi", "Kalite kontrol"],
    ...
    faqs: [
      {
        ...
        answer:
          "Evet, ekipman tipine ve çalışma yogunluguna gore planli bakım takvimi olüst?rabiliyoruz.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    relatedMachines: ["Depolama ve Besleme Sistemleri", "Paketleme ve Dolum Sistemleri"],
    relatedProjects: ["Kompost Tesisi Projeleri", "özel Proses ve Makine 0malatı"],
    faqs: [
      {
...
export const projects: ProjectItem[] = [
  ...
  },
  {
    ...
    similarProject: "özel Proses ve Makine 0malatı Projeleri",
...
export const librarySections: { title: LibraryCategory; description: string }[] = [
  {
    ...
    description: "Sektöre yon veren, arama niyeti guclu makaleler ve konu kumeleri.",
  },
  {
...
export const libraryItems: LibraryItem[] = [
  {
    ...
    heroDescription:
      "Kompost tesisi kurmak isteyen yatirimcilar için saha seçimi, ekipman yapısı, proses ak??? ve kapasite planlamasini sade ama guclu sekilde acikliyoruz.",
    sections: [
      {
        heading: "Kurulum mantigi",
        text: "Kompost tesisleri yalnizca ekipman secimiyle değil; kabul alani, malzeme ak???, on hazırlama, kompostlama ve son ürün yonetimiyle birlikte ele alinmalidir.",
      },
      {
  ...
  },
  {
    ...
    relatedLinks: ["Granülasyon Nedir", "Gübre Granülasyon Hatti Nasil Çalığır"],
  },
  {
    slug: "gubre-granulasyon-hatti-nasil-calisir",
    title: "Gübre Granülasyon Hatti Nasil Çalığır",
    category: "Teknik Rehberler",
    ...
    heroDescription:
      "Granül olüstırma, kurutma, sınıflandırma ve geri donus akisini sistem bazinda anlatiyoruz.",
    sections: [
      {
        heading: "Hat yapisi",
    ...
    relatedLinks: ["Organomineral Gübre Üretim Süreci", "Tambur Kurutma Sistemleri Nasil Çalığır"],
  },
  {
  ...
  },
  {
    ...
    title: "Tambur Kurutma Sistemleri Nasil Çalığır",
    category: "Teknik Rehberler",
  ...
  },
  {
    ...
    relatedLinks: ["Gübre Granülasyon Hatti Nasil Çalığır", "Organomineral Gübre Nedir"],
  },
  {
    slug: "trommel-nedir",
    title: "Trommel Nedir",
