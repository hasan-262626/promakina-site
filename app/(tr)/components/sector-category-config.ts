...
export const sectorCategoryConfigs: Record<string, SectorCategoryConfig> = {
  "kompost-ve-organik-atik-tesisleri": {
    ...
    machineCards: [
      ...
      { title: "Kurutma Tamburu", text: "Yüksek nemli akışlarda hacim azaltma ve ürün kondisyonu sağlar.", href: "/makinalar-ekipman/tambur-sistemleri/kurutma-tamburu" },
      ...
      { title: "Bantlı Konveyörler", text: "Hazırlama, tambur ve son ürün noktaları arasında kesintisiz transfer kurar.", href: "/makinalar-ekipman/tasima-ekipmanlari/bantli-konveyorler" },
  ...
  "enerji-ve-biyogaz-sistemleri": {
    ...
    machineCards: [
      ...
      { title: "Helezon ve Konveyör Hatları", text: "Nemli ve lifli akışlarda güvenli transfer altyapısı kurar.", href: "/makinalar-ekipman/tasima-ekipmanlari/vidali-helezonlar" },
  ...
  "madencilik-ve-mineral-isleme": {
    ...
    machineCards: [
      ...
      { title: "Kurutma Tamburu", text: "Nemli mineral akışlarda kontrollü kurutma sağlar.", href: "/makinalar-ekipman/tambur-sistemleri/kurutma-tamburu" },
      { title: "Bantlı Konveyörler", text: "Hat içi transferi kesintisiz ve güvenli biçimde tamamlar.", href: "/makinalar-ekipman/tasima-ekipmanlari/bantli-konveyorler" },
  ...
  "geri-donusum-ve-atik-yonetimi": {
    ...
    machineCards: [
      ...
      { title: "Bantlı Konveyörler", text: "Hat içi transferi dengeli ve güvenli biçimde sürdürür.", href: "/makinalar-ekipman/tasima-ekipmanlari/bantli-konveyorler" },
  ...
  "yem-toz-ve-dokme-kati-malzeme-isleme-sistemleri": {
    ...
    machineCards: [
      ...
      { title: "Bantlı Konveyörler", text: "Yatay transfer noktalarında dengeli ve temiz akış sağlar.", href: "/makinalar-ekipman/tasima-ekipmanlari/bantli-konveyorler" },
      { title: "Vidalı Helezonlar", text: "Toz ve granül akışlarda kontrollü, kompakt transfer imkanı sunar.", href: "/makinalar-ekipman/tasima-ekipmanlari/vidali-helezonlar" },
      { title: "Kovalı Elevatörler", text: "Dikey taşıma gereken proses noktalarında ürün sürekliliğini destekler.", href: "/makinalar-ekipman/tasima-ekipmanlari/zincirli-elevatorler" },
