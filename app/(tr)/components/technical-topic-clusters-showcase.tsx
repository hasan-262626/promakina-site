    ...
    <div id="teknik-makaleler" className="space-y-8 scroll-mt-24">
      ...
      <div className="grid gap-6 xl:grid-cols-2">
        {filteredClusters.map((cluster) => {
          ...
          const listId = `technical-cluster-${cluster.slug}-articles`;
          ...
          return (
            ...
            >
              ...
              <div id={listId} className="mt-6 grid gap-3">
              ...
              {hasMore ? (
                <button
                  ...
                  className="mt-4 inline-flex rounded-full border border-white/35 px-4 py-2 text-sm font-semibold text-white transition hover:bg-white/10 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#278DC0]"
                >
