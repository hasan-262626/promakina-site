            ...
            <div className="space-y-6">
              <div className="rounded-3xl border border-blue-100 bg-white p-6 shadow-[0_18px_50px_rgba(15,23,42,0.06)]">
                ...
                <div className="mt-6 grid gap-5 md:grid-cols-2">
                  <SelectField label="Sistem Tipi" value={geometry.systemType} onChange={(value) => setGeometry((current) => ({ ...current, systemType: value, helix: value === "Helisel Konik Dişli" && n(current.helix) === 0 ? "15" : value === "Düz Konik Dişli" ? "0" : current.helix }))} options={SYSTEM_OPTIONS.map((value) => ({ value, label: value }))} helperText="Bu alanı siz doldürün" limitText="β = 0° ise düz, 0° üzeri ise helisel konik dişli" tip="Helis açısı 0° ise sistem düz, 0° üzerindeyse helisel konik dişli karakteri gösterir." tipId="bg-system" openTip={openTip} setOpenTip={setOpenTip} />
                  <SelectField label="Modül (mn)" value={geometry.module} onChange={(value) => setGeometry((current) => ({ ...current, module: value }))} options={moduleOptions} helperText="Bu alanı siz doldürün" limitText="Standart modül seçiniz" tip="Konik dişlinin temel boyutunu belirleyen ana ölçüdür. Modül büyüdükçe çap ve diş boyutları artar." tipId="bg-module" openTip={openTip} setOpenTip={setOpenTip} />
                  <InputField label="Döndüren Diş Sayısı (Z1)" value={geometry.z1} onChange={(value) => setGeometry((current) => ({ ...current, z1: value }))} helperText="Bu alanı siz doldürün" limitText="Döndüren dişli için önerilen minimum diş sayısı kontrol edilmelidir" error={geometryData.errors.z1} tip="Döndüren dişlinin diş sayısıdır." tipId="bg-z1" openTip={openTip} setOpenTip={setOpenTip} />
                  <InputField label="Döndürülen Diş Sayısı (Z2)" value={geometry.z2} onChange={(value) => setGeometry((current) => ({ ...current, z2: value }))} helperText="Bu alanı siz doldürün" limitText="Döndürülen dişli için düşük diş sayıları çalışma karakterini etkileyebilir" error={geometryData.errors.z2} tip="Döndürülen dişlinin diş sayısıdır." tipId="bg-z2" openTip={openTip} setOpenTip={setOpenTip} />
                  <SelectField label="Toplam Çalışma Açısı (ε)" value={geometry.epsilon} onChange={(value) => setGeometry((current) => ({ ...current, epsilon: value }))} options={epsilonOptions} helperText="Bu alanı siz doldürün" limitText="Konik dişli hesaplarında toplam çalışma açısı genellikle 90° alınır" tip="İki dişli ekseni arasındaki çalışma açısıdır. Çoğu klasik uygulamada 90° kullanılır." tipId="bg-epsilon" openTip={openTip} setOpenTip={setOpenTip} />
                  <SelectField label="Diş Profil Açısı (α)" value={geometry.pressure} onChange={(value) => setGeometry((current) => ({ ...current, pressure: value }))} options={pressureOptions} helperText="Bu alanı siz doldürün" tip="Diş temas geometrisini belirleyen temel standart açıdır. Genellikle 20° kullanılır." tipId="bg-pressure" openTip={openTip} setOpenTip={setOpenTip} />
                  <SelectField label="Helis Açısı (β)" value={geometry.helix} onChange={(value) => setGeometry((current) => ({ ...current, helix: value, systemType: n(value) > 0 ? "Helisel Konik Dişli" : "Düz Konik Dişli" }))} options={helixOptions} helperText="Bu alanı siz doldürün" limitText="0° = düz konik dişli, 0° üzeri = helisel konik dişli" tip="Helisel konik dişli sistemlerinde dişlerin eğim açısıdır. 0° değeri düz konik dişli anlamına gelir." tipId="bg-helix" openTip={openTip} setOpenTip={setOpenTip} />
                  <InputField label="Döndüren Z1 Dişli Devri" value={geometry.rpm} onChange={(value) => setGeometry((current) => ({ ...current, rpm: value }))} unit="dev/dk" helperText="Bu alanı siz doldürün" limitText="0'dan büyük olmalıdır" error={geometryData.errors.rpm} tip="Döndüren dişlinin dakikadaki dönüş sayısıdır." tipId="bg-rpm" openTip={openTip} setOpenTip={setOpenTip} />
                  <InputField label="Diş Genişliği / Yüz Genişliği" value={geometry.faceWidth} onChange={(value) => setGeometry((current) => ({ ...current, faceWidth: value }))} unit="mm" helperText="Bu alanı siz doldürün" limitText="Koni boyuna göre aşırı büyük seçilmemelidir" error={geometryData.errors.faceWidth} liveText={`Önerilen üst sınır yaklaşık ${fmt(geometryData.recommendedB, " mm")}`} tip="Diş genişliği, koni ana doğrusu ile ilişkilidir ve taşıma kapasitesi ile üretim hassasiyetini etkiler." tipId="bg-face" openTip={openTip} setOpenTip={setOpenTip} />
                  <InputField label="Mil Çapı 1" value={geometry.shaft1} onChange={(value) => setGeometry((current) => ({ ...current, shaft1: value }))} unit="mm" helperText="Bu alanı siz doldürün" limitText="Göbek ve dişli geometrisine uygun olmalı" tip="Dişlinin bağlanacağı milin dış çapıdır." tipId="bg-shaft1" openTip={openTip} setOpenTip={setOpenTip} />
                  <InputField label="Mil Çapı 2" value={geometry.shaft2} onChange={(value) => setGeometry((current) => ({ ...current, shaft2: value }))} unit="mm" helperText="Bu alanı siz doldürün" limitText="Göbek ve dişli geometrisine uygun olmalı" tip="Dişlinin bağlanacağı milin dış çapıdır." tipId="bg-shaft2" openTip={openTip} setOpenTip={setOpenTip} />
                  <InputField label="Göbek Çapı 1" value={geometry.hub1} onChange={(value) => setGeometry((current) => ({ ...current, hub1: value }))} unit="mm" helperText="Bu alanı siz doldürün" limitText="Min: mil çapısından büyük olmalı • Max: diş kökü bölgesini aşmamalı" liveText={geometryData.hubInfo1} error={geometryData.errors.hub1} tip="Dişlinin merkez göbek bölgesinin dış çapıdır. Diş kökü geometrisini zayıflatmamalıdır." tipId="bg-hub1" openTip={openTip} setOpenTip={setOpenTip} />
                  <InputField label="Göbek Çapı 2" value={geometry.hub2} onChange={(value) => setGeometry((current) => ({ ...current, hub2: value }))} unit="mm" helperText="Bu alanı siz doldürün" limitText="Min: mil çapısından büyük olmalı • Max: diş kökü bölgesini aşmamalı" liveText={geometryData.hubInfo2} error={geometryData.errors.hub2} tip="Dişlinin merkez göbek bölgesinin dış çapıdır. Diş kökü geometrisini zayıflatmamalıdır." tipId="bg-hub2" openTip={openTip} setOpenTip={setOpenTip} />
                </div>
              </div>
