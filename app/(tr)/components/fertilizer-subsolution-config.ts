...
const liquidEquipment: SubsolutionCard[] = [
  ...
  { title: "Homojenizatör", text: "Partiler aras? kalite fark?n? azaltmak ve ürün stabilitesini artırmak için homojenizasyon çözümleri." },
  ...
  { title: "Stok / Mamul Tanklar?", text: "Dolum öncesi mamul ürünün güvenli ?ekilde bekletilmesi ve dengelenmesi için tank sistemleri." },
  { title: "Dozajlama Sistemleri", text: "Sıvı ve kat? bileşenlerin reçeteye uygun kontrollü beslenmesi için dozaj altyapıs?." },
  { title: "Sıvı Dolum ?zi?eleme", text: "?zi?e, bidon veya özel ambalaj yap?lar? için hassas sıvı dolum çözümleri." },
  { title: "?zi?e Etiketleme Makinas?", text: "Son ürünün düzgün, h?zl? ve standart etiketlenmesi için etiketleme sistemleri." },
];
...
const granuleEquipment: SubsolutionCard[] = [
  ...
  { title: "Kurutma Tamburu", text: "Granül ürünün hedef neme ula?mas? ve stabil hale gelmesi için kontrollü kurutma sağlar." },
  ...
  { title: "Paketleme ve Paletleme çözümleri", text: "Son ürünün torbalanmas?, istiflenmesi ve sevkiyata hazırlanmas? için entegre son hat çözümleridir." },
];
...
const granuleCompostEquipment: SubsolutionCard[] = [
  ...
  { title: "Paketleme ve Paletleme çözümleri", text: "Granül kompost ürünün?n torbalanmasi, paletlenmesi ve sevkiyata hazirlanmasi için son hat entegrasyonu sunar." },
];
...
const powderEquipment: SubsolutionCard[] = [
  ...
  { title: "Elevatör Sistemleri", text: "Dikey transfer ihtiyaç? olan noktalarda düzenli ürün akışı için kullanılır." },
  ...
  { title: "Paketleme Sistemleri", text: "Toz son ürünün torbalama ve sevkiyat hazırl??ında kontrollü dolum sağlar." },
];
...
const liquidCommonFields: SubsolutionFormField[] = [
  ...
  { id: "automationLevel", label: "Otomasyon Seviyesi", type: "select", options: ["Yar? Otomatik", "Tam Otomatik", "Henüz net değil"] },
  { id: "fillingNeed", label: "Dolum İhtiyac?", type: "select", options: ["Evet", "Hayır", "Henüz net değil"] },
];

const granuleCommonFields: SubsolutionFormField[] = [
  { id: "hourlyCapacity", label: "Saatlik Kapasite", type: "number", unit: "ton/saat" },
  { id: "automationLevel", label: "Otomasyon Seviyesi", type: "select", options: ["Yar? Otomatik", "Tam Otomatik", "Henüz net değil"] },
  { id: "packagingNeed", label: "Paketleme İhtiyac?", type: "select", options: ["Evet", "Hayır", "Henüz net değil"] },
  { id: "granuleSize", label: "Granül Boyutu", type: "text" },
  { id: "dryingNeed", label: "Kurutma İhtiyac?", type: "select", options: ["Evet", "Hayır", "Henüz net değil"] },
];
...
const powderCommonFields: SubsolutionFormField[] = [
  ...
  { id: "automationLevel", label: "Otomasyon Seviyesi", type: "select", options: ["Yar? Otomatik", "Tam Otomatik", "Henüz net değil"] },
  { id: "packagingNeed", label: "Paketleme İhtiyac?", type: "select", options: ["Evet", "Hayır", "Henüz net değil"] },
  { id: "screeningNeed", label: "Eleme İhtiyac?", type: "select", options: ["Evet", "Hayır", "Henüz net değil"] },
  { id: "dustControlNeed", label: "Toz Kontrol İhtiyac?", type: "select", options: ["Evet", "Hayır", "Henüz net değil"] },
];
...
const liquidOfferCardsBySlug: Record<string, SubsolutionCard[]> = {
  "sivi-organomineral": [
    ...
    { title: "Dolum ve Son Hat Uyumlar?", text: "IBC, bidon, ?i?e veya özel ambalaj yapısına uygun dolum ve etiketleme çözümleri sunuyoruz." },
  ...
  "sivi-npk": [
    { title: "Proses Tasarım?", text: "Hedef NPK analizi, çözünürlük s?n?rlar? ve hammadde davran???na göre sıvı üretim sürecini planlıyoruz." },
    { title: "Uygun Makine Kurgusu", text: "çözündürme, kar??tırma, homojenizasyon, filtrasyon ve dolum için doru makine kombinasyonunu oluşturuyoruz." },
    ...
    { title: "Dolum ve Son Hat Uyumlar?", text: "?zi?e, bidon veya IBC senaryolarına uygun dolum ve etiketleme çözümleri sunuyoruz." },
    { title: "Anahtar Teslim Kurulum", text: "Makine imalat?, saha yerle_imi, kurulum ve devreye alma dahil entegre tesis kurgusu sunuyoruz." },
  ],
  "sivi-amino-asit": [
    { title: "Amino Asit Bazl? Proses Tasarım?", text: "Amino asit kayna??na, berraklık ihtiyacına ve hedef kullanım senaryosuna göre proses altyapısın? planlıyoruz." },
    { title: "Uygun Tank ve Filtrasyon Kurgusu", text: "çözeltinin davran???na göre kar??tırma, bekletme ve filtrasyon altyapısın? birlikte oluşturuyoruz." },
    { title: "Stabilite ve Berraklık Yönetimi", text: "ürünün görsel kalitesini ve depolama kararlılığın? destekleyecek proses yakla??m? geliştiriyoruz." },
  ...
  "organik-sivi-gubre": [
    { title: "Organik ??erik Uyumlu Proses Tasarım?", text: "Doçal menşeli hammaddelerin davran???na göre karışım, bekletme ve dolum altyapısın? planlıyoruz." },
    { title: "Tank ve Kar???m Altyapıs?", text: "Organik fraksiyonların dengeli birle?imi için doru tank, kar??tür?c? ve transfer yapısın? kuruyoruz." },
    { title: "Koku ve Stabilite Yakla??m?", text: "ürün kararlılığı ile proses konforunu birlikte ele alan teknik çözümler geliştiriyoruz." },
  ...
  "organik-biyostimulan": [
    ...
    { title: "Esnek Dolum çözümleri", text: "?zi?e, bidon veya farkl? hacimlerde ambalaj senaryolarına uygun dolum altyapıs? kuruyoruz." },
...
const granuleOfferCardsBySlug: Record<string, SubsolutionCard[]> = {
  "granul-organomineral": [
    ...
    { title: "Granülasyon Sistemi Seçimi", text: "Reçete yapıs?, bağlayıc? ihtiyaç? ve hedef granül karakterine göre doru granülasyon çözüm?n? belirliyoruz." },
  ...
  "granul-npk": [
    ...
    { title: "Granülasyon Hatt? Seçimi", text: "Formülasyona ve kapasite ihtiyacına göre uygun granülasyon altyapısın? belirliyoruz." },
    ...
    { title: "Son Hat ve Paketleme çözümleri", text: "Torbalama, paletleme ve sevkiyata hazırl?k için entegre son hat senaryolar? geliştiriyoruz." },
    { title: "Anahtar Teslim Kurulum", text: "Makine imalat?, saha yerle_imi, kurulum ve devreye alma dahil entegre tesis kurgusu sunuyoruz." },
  ],
};
...
const powderOfferCardsBySlug: Record<string, SubsolutionCard[]> = {
  "toz-organomineral": [
    ...
    { title: "Homojen Kar???m Yakla??m?", text: "Farkl? younluk ve akış karakterine sahip hammaddeler için doru karışım yapısın? oluşturuyoruz." },
    { title: "Toz Kontrol ve Filtrasyon", text: "Transfer ve paketleme noktalarında emisyonu azaltan toz emi? çözümleri geliştiriyoruz." },
    { title: "Eleme ve Son ürün Hazırlama", text: "Topak kontrolü, ürün standard? ve torbalamaya uygun son ürün hazırl??? için eleme çözümleri sunuyoruz." },
    { title: "Anahtar Teslim Kurulum", text: "Makine imalat?, saha yerle_imi, kurulum ve devreye alma dahil entegre tesis kurgusu sunuyoruz." },
  ],
  "toz-npk": [
    { title: "Reçete Bazl? Toz Hat Tasarım?", text: "Hedef NPK analizi ve ürün akış davran???na göre toz üretim hattının temel yapısın? planlıyoruz." },
    ...
    { title: "Toz Emi? Altyapıs?", text: "Transfer ve paketleme noktalarında toz oluşumunu kontrol altında tutan emi? çözümleri geliştiriyoruz." },
    { title: "Paketleme Uyumu", text: "Son ürünün akış davran???na uygun torbalama ve son hat senaryoların? projeye dahil ediyoruz." },
    { title: "Anahtar Teslim Kurulum", text: "Makine imalat?, saha yerle_imi, kurulum ve devreye alma dahil entegre tesis kurgusu sunuyoruz." },
  ],
};
...
const liquidCriticalTopicsBySlug: Record<string, SubsolutionCard[]> = {
  "sivi-organomineral": [
    { title: "çözünürlük ve stabilite", text: "ürün içinde ??kme, ayr??ma ve bulan?kl?k oluşmamas? için proses doru kurulmalıdır." },
    ...
    { title: "Ambalaj ve dolum uyumu", text: "Son ürünün akışkanl??? ve viskozitesi dolum hatt?yla uyumlu olmalıdır." },
    { title: "Depolama kararlılığı", text: "Mamul tankında bekleme süresince ürün yapısının bozulmamas? önemlidir." },
    { title: "Temizlik ve hat hijyeni", text: "ürün geçişleri ve hat temizliği, kalite süreklili?i açısından dikkatle planlanmalıdır." },
  ],
  "sivi-npk": [
    { title: "çözünürlük ve stabilite", text: "Yüksek analizli NPK formüllerde çözeltinin berrak ve kararl? kalmas? için çözünürlük s?n?rlar? iyi yönetilmelidir." },
    ...
    { title: "Ambalaj ve dolum uyumu", text: "ürünün yo?unlu?u ve akış karakteri seçilen dolum ambalaj? ile uyumlu olmalıdır." },
  ...
  "sivi-amino-asit": [
    { title: "çözünürlük ve stabilite", text: "Protein hidrolizat? veya amino asit bazl? ürünlerde berraklık ve uzun s?reli stabilite birlikte değerlendirilmelidir." },
  ...
  "organik-sivi-gubre": [
    { title: "çözünürlük ve stabilite", text: "Organik fraksiyonlu ürünlerde ??kme, bulan?kl?k ve faz ayrım? oluşmamas? için stabilite doru yönetilmelidir." },
    { title: "Hammadde uyumu", text: "Doçal menşeli içeriklerin birlikte davran???, akışkanl?k ve raf ömrü açısından dikkatle değerlendirilmelidir." },
    ...
    { title: "Ambalaj ve dolum uyumu", text: "Dolum ekipman?, ürünün viskozite ve akış karakterine uygun seçilmelidir." },
    ...
    { title: "Temizlik ve hat hijyeni", text: "Organik ürün geçişlerinde hat hijyeni ve temizlik plan? kalite güvence açısından kritik önemdedir." },
  ],
  "organik-biyostimulan": [
    { title: "çözünürlük ve stabilite", text: "Biyostimülan karakter ta??yan aktif fraksiyonların çözeltide kararl? kalmas? için stabilite doru yönetilmelidir." },
    ...
    { title: "pH ve reaksiyon kontrol?", text: "Aktif içeriklerin performansın? korumak için pH ve reaksiyon penceresi kontrollü tutulmalıdır." },
    { title: "Filtrasyon seviyesi", text: "Dolum öncesi filtrasyon seviyesi, berraklık kadar uygulama güvenliği açısından da önem ta??r." },
    ...
    { title: "Ambalaj ve dolum uyumu", text: "ürünün hedef ambalaj ve uygulama senaryosuna uyumu dolum hatt? seçimini dorudan etkiler." },
...
const granuleCriticalTopicsBySlug: Record<string, SubsolutionCard[]> = {
  "granul-organomineral": [
    ...
    { title: "Nem kontrol?", text: "Kurutma ??k???ndaki nem seviyesi, hem depolama kararlılığı hem de granül bütünl??? açısından kritik önemdedir." },
    ...
    { title: "Kurutma verimi", text: "Yetersiz veya a??r? kurutma granül yapısın? ve i?letme maliyetini dorudan etkiler." },
  ...
  "granul-npk": [
    { title: "Granül dayanım?", text: "Yüksek analizli NPK granüllerinin k?r?lmadan ta??nmas? için granülasyon ve bağlayıc? dengesi doru kurulmalıdır." },
    ...
    { title: "Tane boyutu standard?", text: "Hedef granül çap?, ürünün pazardaki kabul? ve paketleme performans? açısından istikrarl? olmalıdır." },
    ...
    { title: "Toz kontrol?", text: "Granül NPK hatlarında olu?an tozun etkin biçimde yönetilmesi hem çevre hem de ürün kayb? açısından önemlidir." },
    { title: "Paketleme performans?", text: "Son ürünün akış karakteri ve tane bütünl???, torbalama ve paletleme süreçleriyle uyumlu olmalıdır." },
  ],
  "granul-kompost-tesisleri": [
    ...
    { title: "Granül dayanım?", text: "Son ürünün ta??ma ve paketleme s?rasında da??lmamas? için granül mukavemeti önemlidir." },
    ...
    { title: "Depolama kararlılığı", text: "Son ürünün depoda topaklanmamas? ve akışkanlılığın? korumas? gerekir." },
    { title: "Paketleme performans?", text: "Granül ürünün torbalama ve sevkiyat performans? son kalite açısından önemlidir." },
  ],
};
...
const powderCriticalTopicsBySlug: Record<string, SubsolutionCard[]> = {
  "toz-organomineral": [
    ...
    { title: "Ak?? davran???", text: "Organik katkıl? toz ürünlerde köprülenme ve düzensiz akış riskleri besleme performansın? etkileyebilir." },
  ...
  "toz-npk": [
    ...
    { title: "Ak?? davran???", text: "Toz NPK ürünlerde akış düzeni torbalama performansın? ve besleme kararlılığın? dorudan etkiler." },
    ...
    { title: "Ambalaj uyumu", text: "ürünün akışkanl??? ve y???n davran??? seçilen paketleme sistemiyle uyumlu olmalıdır." },
...
const liquidFaqsBySlug: Record<string, SubsolutionFaq[]> = {
  "sivi-organomineral": [
    ...
    { question: "Filtrasyon neden ?nemlidir?", answer: "Filtrasyon, ürün berraklığın?, dolum hatt? güvenliçini ve son kullan?c? uygulama performansın? dorudan etkiler." },
    ...
    { question: "Mevcut sıvı gübre hatt? revize edilebilir mi?", answer: "Evet, mevcut ekipman yapısına göre kapasite art???, filtrasyon iyile?tirmesi, yeni ürün adaptasyonu ve dolum entegrasyonu yapılabilir." },
  ],
  "sivi-npk": [
    ...
    { question: "Kristalle?me riski nasıl yönetilir?", answer: "çözünürlük s?n?rlar?, sıcaklık yönetimi, pH dengesi ve filtrasyon kademeleri birlikte değerlendirilerek kristalle?me riski azalt?l?r." },
    { question: "Dolum ?ncesi dinlendirme gerekli midir?", answer: "Formülasyona ba?l? olarak homojenizasyon sonras? kontrollü bekletme, ürün kararlılığı açısından avantaj sa?layabilir." },
    { question: "Mevcut sıvı gübre hatt? NPK üretimi için revize edilebilir mi?", answer: "Evet, mevcut tank, filtrasyon ve dozajlama yapıs? incelenerek NPK odakl? üretime uygun revizyon yapılabilir." },
  ],
  "sivi-amino-asit": [
    ...
    { question: "Sivi amino asit ?retiminde filtrasyon neden kritiktir?", answer: "Filtrasyon, hem dolum hattının güvenli çalışmas?n? hem de son ürünün görsel ve uygulama performansın? dorudan etkiler." },
    ...
    { question: "Koku ve renk farklar? kontrol alt?na al?nabilir mi?", answer: "Ham madde yapısına ba?l? deği?imler proses s?ras?, karışım koşullar? ve uygun yardımcılarla yönetilebilir." },
  ...
  "organik-sivi-gubre": [
    ...
    { question: "Dolum öncesi berraklık her zaman gerekli midir?", answer: "Bu, hedef ürünün kullanım ?ekline ba?l?d?r; ancak dolum güvenliği ve son kullan?c? deneyimi için uygun filtrasyon seviyesi önemlidir." },
  ...
  "organik-biyostimulan": [
    ...
    { question: "Biyostimülan ürünlerde filtrasyon neye göre belirlenir?", answer: "Filtrasyon seviyesi, ürünün aktif fraksiyonu, hedef berrakl??? ve dolum sonras? kullanım ?ekline göre seçilir." },
    ...
    { question: "Mevcut sıvı tesis biyostimülan üretimi için revize edilebilir mi?", answer: "Evet, mevcut ekipman altyapıs? incelenerek aktif içeriklere uygun karışım, filtrasyon ve dolum iyile?tirmeleri yapılabilir." },
  ],
};
...
const granuleFaqsBySlug: Record<string, SubsolutionFaq[]> = {
  "granul-organomineral": [
    ...
    { question: "Kurutma her granül hat için gerekli midir?", answer: "ürün yapısına göre deği?mekle birlikte granül kararlılığı ve depolama performans? için ?o?u hatta kurutma kritik rol oynar." },
    { question: "Mevcut granül hat organomineral üretime uyarlanabilir mi?", answer: "Evet, granülasyon, kurutma, eleme ve toz kontrol kademeleri incelenerek organomineral yap?ya uygun revizyon yapılabilir." },
  ],
  "granul-npk": [
    ...
    { question: "Granül boyutu neden bu kadar önemlidir?", answer: "Granül boyutu hem ürünün pazardaki kabul?n? hem de paketleme ve uygulama performansın? dorudan etkiler." },
    { question: "Kurutma ve soğutma her zaman birlikte mi deerlendirilir?", answer: "Evet, granül ürünün nem ve sıcaklık dengesi son ürün kararlılığı için birlikte ele al?nmalıdır." },
  ...
  "granul-kompost-tesisleri": [
    ...
    { question: "Kompost bazl? hammaddelerde granül dayanım? nasıl sağlan?r?", answer: "Doru nem dengesi, uygun karışım yapıs?, bağlayıc? ihtiyaç? ve kontrollü kurutma ile granül dayanım? desteklenir." },
...
const powderFaqsBySlug: Record<string, SubsolutionFaq[]> = {
  "toz-organomineral": [
    ...
    { question: "Toz kontrolü neden kritik g?r?l?r?", answer: "Toz emi? ve filtrasyon altyapıs? hem çevresel güvenlik hem de ürün kaybının azalt?lmas? açısından önemlidir." },
  ...
  "toz-npk": [
    ...
    { question: "Mevcut toz gübre hatt? NPK üretimi için revize edilebilir mi?", answer: "Evet, mevcut besleme, kar??tırma, eleme ve paketleme sistemleri incelenerek NPK odakl? revizyon yapılabilir." },
  ],
};
const fertilizerSubsolutionConfigs: Record<string, FertilizerSubsolutionConfig> = {
  "sivi-organomineral": {
    ...
    namingExplanation: "Sıvı organomineral gübreler, organik kökenli bileşenler ile mineral besin elementlerinin ayn? formülasyonda bir araya getirildi?i ürün grubudur. Bu nedenle ürün, sadece mineral gübre ya da sadece organik bazl? bir ürün olarak değil; organik içerik ile bitki besleme amaçl? mineral bileşenleri birlikte ta??yan bir yap? olarak deerlendirilir. Formülasyonda hem organik karakter kazand?ran içerikler hem de bitkinin ihtiyaç duydu?u mineral besin kaynaklar? bulundu?u için organomineral ifadesi kullanılır.",
    namingNote: "ürünün nihai sınıf?, kullanılan organik fraksiyonun yapısına, mineral besin içeriçine ve hedef pazardaki mevzuat tan?m?na göre netleşir.",
    ...
    formDescription: "Kapasite, batch yapıs?, ürün reçetesi, hammadde tipi ve dolum ihtiyacınıza göre size uygun sıvı gübre üretim çözüm?n? birlikte değerlendirelim.",
  ...
  "sivi-npk": {
    ...
    namingExplanation: "NPK ifadesi, ürünün temel bitki besin elementleri olan azot (N), fosfor (P) ve potasyumu (K) birlikte içermesinden gelir. ürün sıvı formda hazırlanm?? olsa da ana besleme omurgas? N, P ve K ise Sıvı NPK Gübre olarak adland?r?l?r.",
    ...
    formDescription: "Batch kapasitesi, günlük üretim hedefi, hedef NPK formül? ve dolum ihtiyacınıza göre size uygun sıvı NPK üretim çözüm?n? birlikte değerlendirelim.",
  ...
  "sivi-amino-asit": {
    ...
    namingExplanation: "Bu ürün grubunda formülasyonun ana karakterini amino asit içeri?i belirler. ürünün temel fonksiyonu amino asit temelli ise Sıvı Amino Asit Gübre ifadesi teknik olarak doru kabul edilir.",
    ...
    formDescription: "Batch kapasitesi, günlük üretim hedefi, amino asit kayna??, filtrasyon gereksinimi ve dolum ihtiyacınıza göre size uygun çözüm? birlikte değerlendirelim.",
    formFields: [...liquidCommonFields.slice(0, 2), { id: "aminoSource", label: "Amino Asit Kayna??", type: "text" }, { id: "filtrationNeed", label: "Filtrasyon Gereksinimi", type: "select", options: ["Standart", "Yüksek", "Henüz net değil"] }, ...liquidCommonFields.slice(2)],
  },
  "organik-sivi-gubre": {
    heroBadge: "ALT çözüm",
    ...
    namingExplanation: "Bu ürün grubunda formülasyonun ana karakteri organik kökenli bileşenlerden gelir. Besleme ve destek mant??? a??rl?kl? olarak organik içerikler üzerinden kuruldu?u için organik sıvı gübre ifadesi kullanılır.",
    ...
    formDescription: "Organik hammadde yapıs?, batch kapasitesi, stabilite ihtiyaç? ve dolum hedefinize göre size uygun organik sıvı üretim çözüm?n? birlikte değerlendirelim.",
  ...
  "organik-biyostimulan": {
    ...
    namingExplanation: "Biyostimülan ürünler, dorudan klasik NPK besleme mant??ından çok bitkinin geli?im süreçlerini, stres tolerans?n? ve besin kullanım etkinliçini desteklemeye odaklan?r. Bu nedenle formülasyonun ana etkisi biyostimülan karakter ta??yorsa bu isim kullanılır.",
    ...
    formDescription: "Aktif içerik yapıs?, batch kapasitesi, ürün hedefi ve dolum ihtiyacınıza göre size uygun biyostimülan üretim çözüm?n? birlikte değerlendirelim.",
    formFields: liquidCommonFields,
  },
  "granul-organomineral": {
    heroBadge: "ALT çözüm",
    ...
    rawMaterials: ["Organik madde içeren kat? hammaddeler", "Mineral besin elementleri", "Azot, fosfor ve potasyum kaynaklar?", "Organik bazl? ta??y?c? ve bağlayıc? içerikler", "Mikro element katkılar?", "Nem ayar? ve proses yardımcılar?"],
    namingExplanation: "Granül organomineral gübreler, organik içerik ile mineral besin elementlerinin birlikte bulundu?u ve granül formda son ürüne dönüştür?ld??? ürün grubudur. Organomineral ifadesi ürünün ?ift karakterini, granül ifadesi ise son ürün formunu anlatür.",
    ...
    formDescription: "Saatlik kapasite, reçete yapıs?, granül boyutu ve son hat ihtiyacınıza göre size uygun granül üretim çözüm?n? birlikte değerlendirelim.",
  ...
  "granul-npk": {
    ...
    namingExplanation: "Formülasyonun ana omurgas?n? azot (N), fosfor (P) ve potasyum (K) oluşturdu?u için ürün NPK sınıfında deerlendirilir. Son ürün granül formda oldu?u için de NPK Granül Gübre ifadesi kullanılır.",
    ...
    formDescription: "Saatlik kapasite, hedef NPK analizi, granül boyutu ve paketleme ihtiyacınıza göre size uygun granül üretim çözüm?n? birlikte değerlendirelim.",
  ...
  "granul-kompost-tesisleri": {
    ...
    rawMaterials: [
      ...
      "Gerekirse bağlayıc? yardımcılar",
    ...
    namingExplanation: "Bu ürün grubu, ana yapısın? kompost bazl? organik hammaddelerden al?r ve son ürün granül formda elde edilir. Bu nedenle granül kompost ifadesi kullanılır. ürünün temel karakteri organik kompost içeriçine dayan?rken, son ürün formu granül oldu?u için isimlendirme bu iki özelli?i birlikte yans?tür.",
    namingNote: "Nihai ürün sınıfland?rmas?, kompost oran?na, ek katkı yapısına ve hedef pazardaki mevzuata göre netleşir.",
    offerCards: [{ title: "Proses Tasarım?", text: "Kompost bazl? hammaddenin yapısına göre granül üretim ak???n? planlıyoruz." }, { title: "Granülasyon Sistemi Seçimi", text: "Nem, organik yap? ve hedef granül boyutuna göre uygun granülasyon kurgusunu belirliyoruz." }, { title: "Kurutma ve Eleme Hatt?", text: "Granül kompost ürünlerinde stabil nem ve uygun tane boyutu için hat yapısın? oluşturuyoruz." }, { title: "soğutma ve Son ürün Hazırlama", text: "Depolama ve paketleme öncesi ürün kararlılığın? art?ran son i?lemleri planlıyoruz." }, { title: "Toz ve Koku Kontrol?", text: "Organik içerikli üretim süreçlerinde çevresel kontrol ve saha temizliği için uygun sistemler sunuyoruz." }, { title: "Anahtar Teslim Kurulum", text: "Makine imalat?, yerleşim, kurulum ve devreye alma dahil entegre tesis kurgusu sunuyoruz." }],
    equipmentTitle: granuleEquipmentTitle,
    ...
    formDescription: "Kompost yapıs?, hedef granül boyutu, kapasite ve kurulum modelinize göre size uygun granül kompost üretim çözüm?n? birlikte değerlendirelim.",
    formFields: [
      { id: "hourlyCapacity", label: "Saatlik Kapasite", type: "number", unit: "ton/saat" },
  ...
  "toz-organomineral": {
    ...
    namingExplanation: "ürünün hem organik karakter ta??yan bileşenleri hem de mineral besin kaynakların? birlikte içermesi organomineral tan?m?n? oluşturur. Son ürün toz formda sonland?r?ld??? için toz organomineral gübre ifadesi kullanılır.",
    ...
    formDescription: "Saatlik kapasite, reçete yapıs?, dozaj hassasiyeti ve paketleme ihtiyacınıza göre size uygun toz üretim çözüm?n? birlikte değerlendirelim.",
  ...
  "toz-npk": {
    ...
    namingExplanation: "Formülasyonun temel besleme omurgas?n? azot (N), fosfor (P) ve potasyum (K) oluşturdu?u için ürün NPK sınıfında deerlendirilir. Son ürün granül değil, toz formda sonland?r?ld??? için NPK Toz Gübre olarak adland?r?l?r.",
    ...
    formDescription: "Saatlik kapasite, hedef NPK oran?, eleme ihtiyaç? ve paketleme senaryonuza göre size uygun toz üretim çözüm?n? birlikte değerlendirelim.",
