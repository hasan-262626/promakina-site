...
export const glossaryTerms: Record<string, GlossaryTerm> = {
  ...
  "hedef-son-nem": term({
    ...
    links: [
      ...
      calc("Tambur Kapasite Hesabı", "/programlar?modal=tambur-kapasite-hesabi"),
      blog("Kurutma Tamburu Kapasite Hesabı", "/kutuphane/blog/kurutma-tamburu-hesaplama"),
    ],
  }),
  "silis-kumu": term({
    id: "silis-kumu",
  ...
  "tambur-capi": term({
    ...
    links: [
      page("Kurutma Tamburu", "/makinalar-ekipman/tambur-sistemleri/kurutma-tamburu"),
      blog("Kurutma Tamburu Çap Boy Hesabı", "/kutuphane/blog/kurutma-tamburu-hesaplama"),
      calc("Tambur Kapasite Hesabı", "/programlar?modal=tambur-kapasite-hesabi"),
    ],
  }),
  "tambur-boyu": term({
  ...
  "kalis-suresi": term({
    ...
    links: [
      ...
      calc("Tambur Kapasite Hesabı", "/programlar?modal=tambur-kapasite-hesabi"),
      blog("Kurutma Tamburu Nasıl Hesaplanır?", "/kutuphane/blog/kurutma-tamburu-hesaplama"),
    ],
  }),
  "doluluk-orani": term({
    id: "doluluk-orani",
