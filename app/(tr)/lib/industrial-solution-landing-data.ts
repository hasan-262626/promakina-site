...
export const industrialSolutionLandingConfigs: IndustrialSolutionLandingConfig[] = [
  ...
  },
  {
    ...
    relatedArticles: [
      ...
      { title: "Kurutma Tamburu Kapasite Hesabı", description: "See how moisture load and thermal design shape capacity decisions.", href: "/kutuphane/blog/kurutma-tamburu-hesaplama" },
  ...
  },
  {
    ...
    relatedArticles: [
      { title: "Kurutma Tamburu Kapasite Hesabı", description: "Nem yükü ve termal kapasite mantığını detaylı inceleyin.", href: "/kutuphane/blog/kurutma-tamburu-hesaplama" },
