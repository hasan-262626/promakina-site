...
export const metadata: Metadata = {
  ...
  // NOT: Canonical bilerek layout'ta tanımlanmaz. Root layout'taki canonical tüm alt
  // sayfalara miras kalır ve kendi canonical'ı olmayan her sayfayı ana sayfaya
  // işaretler; bu da o sayfaların indekslenmesini engelleyebilir.
  // Ana sayfa canonical'ı app/(tr)/page.tsx içindedir.
  openGraph: {
