    ...
    <main className="min-h-screen bg-white text-slate-900">
      ...
      <section className="section-space">
        <div className="site-container">
          <div className="grid gap-8 xl:grid-cols-[minmax(0,1.7fr)_minmax(320px,0.9fr)] xl:items-start">
            ...
            <div className="rounded-[30px] border border-slate-200 bg-slate-50/70 p-6 shadow-[0_18px_50px_rgba(15,23,42,0.05)] sm:p-7">
              ...
              <div className="mt-5 space-y-3">
                {spotlightLinks.map((item) => (
                  <Link
                    key={item.href}
                    href={item.href}
                    className="group block rounded-[22px] border border-slate-200 bg-white px-5 py-4 transition hover:border-blue-200 hover:bg-blue-50/50"
                  >
