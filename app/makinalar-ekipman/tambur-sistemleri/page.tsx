  ...
  return (
    <main className="min-h-screen bg-white text-slate-900">
      <section
        ...
        style={{
          backgroundImage:
            "linear-gradient(90deg, rgba(5,15,35,0.88) 0%, rgba(5,15,35,0.78) 45%, rgba(5,15,35,0.56) 100%), url('/images/kurutmatam2.jpg')",
        ...
        <div className="site-container flex min-h-[260px] items-center py-14">
          <div className="max-w-3xl text-white">
            <nav className="text-sm text-white/72">
              ...
              <span className="px-2 text-white/40">/</span>
              <span className="text-white">Tambur Sistemleri</span>
            </nav>
